...
- CRITICAL: Do NOT use emojis anywhere in your planning sections (<plan>) or your task lists (<task_list>). Keep them completely emoji-free.
...
- CRITICAL: Do NOT use emojis anywhere in the plan panel (title, body, tasks) or in the live task lists. Keep them completely emoji-free.

...
export { formatMemoryContext } from "./shared.js";
 ...
 * global rules -> initial guidance -> mode section -> delegation -> memory ->
 * project context. A lightweight strategy (chat) returns its entire prompt
 * standalone, so no wrapping is applied.
 */
